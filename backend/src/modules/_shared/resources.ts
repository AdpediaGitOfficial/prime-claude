...
export const RESOURCES: Record<string, ResourceConfig & { path: string }> = {
  ...
  hallBookings: {
    ...
    model: "hallBooking",
    label: "Hall booking",
    searchFields: ["reference", "fullName", "phone", "email", "organisationName", "eventType"],
    sortFields: ["createdAt", "date", "attendance", "status", "fullName", "reference"],
    allowedStatuses: [...BOOKING_STATUSES],
  ...
  spaBookings: {
    ...
    model: "spaBooking",
    label: "Spa booking",
    searchFields: ["reference", "fullName", "email", "phone", "selectedService"],
    sortFields: ["createdAt", "date", "status", "fullName", "reference"],
    allowedStatuses: [...BOOKING_STATUSES],
  ...
  courseRegistrations: {
    ...
    searchFields: ["reference", "fullName", "email", "phone", "course"],
    sortFields: ["createdAt", "status", "fullName", "reference"],
    allowedStatuses: [...LEAD_STATUSES],
