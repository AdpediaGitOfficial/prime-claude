    ...
    <div className="bg-white text-black overflow-x-hidden">
      ...
      <section className="site-container">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-5 mb-4 md:mb-5">
          ...
          <div
            className="rounded-[20px] p-5 flex flex-col gap-5 shadow-sm hover:shadow-md transition-shadow"
            style={{ background: "#fdf0e9" }}
          >
            <div className="flex items-center justify-between">
              ...
              <span className="bg-white rounded-[19px] px-3 py-1 text-sm md:text-[18px] text-black leading-[1.35]">
                available
              </span>
            </div>
            <div className="flex flex-col gap-4 md:gap-5">
              <div className="flex items-center gap-2">
                <img
                  src="/ICONS/sq-feet.png"
                  alt=""
                  className="w-6 h-6 md:w-7 md:h-7 object-contain flex-shrink-0"
                />
                <p className="text-base md:text-xl leading-[1.35]">12 sq.m</p>
              </div>
            ...
            <button className="mt-auto bg-black text-white rounded-[30px] md:rounded-[54px] w-full flex items-center justify-center font-medium text-lg md:text-[22px] capitalize h-12 md:h-[64px] transition-transform active:scale-95">
              Enquire Now
            </button>
          </div>
            ...
            <div className="flex flex-col gap-4 md:gap-5">
              <div className="flex items-center gap-2">
                <img
                  ...
                  className="w-6 h-6 md:w-7 md:h-7 object-contain flex-shrink-0"
                />
                <p className="text-base md:text-xl leading-[1.35]">14 sq.m</p>
              </div>
              <div className="flex items-center gap-3">
                <img
                  src="/ICONS/map.png"
          ...
          {/* Counter B1 — occupied */}
          <div
            className="rounded-[20px] p-5 flex flex-col gap-5 opacity-80"
            style={{ background: "#fdf0e9" }}
          >
            <div className="flex items-center justify-between">
              <p className="text-lg md:text-[22px] font-medium leading-[1.35]">
              ...
              <span className="bg-white rounded-[19px] px-3 py-1 text-sm md:text-[18px] text-red-500 leading-[1.35]">
                occupied
              </span>
            </div>
            <div className="flex flex-col gap-4 md:gap-5">
            ...
            <button className="mt-auto bg-white text-black rounded-[30px] md:rounded-[54px] w-full flex items-center justify-center font-medium text-lg md:text-[22px] capitalize h-12 md:h-[64px] cursor-not-allowed">
              Not Available
            </button>
          </div>
